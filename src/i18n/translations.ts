...
export const ui = {
  ru: {
    ...
    'hero.title': 'Один человек. Семь агентов.',
    ...
    'features.steve': 'Продуктовый стратег и ментор. Задаёт правильные вопросы.',
    'features.max': 'Инфраструктура. Код, серверы, деплой. Серый кардинал.',
  ...
  en: {
    ...
    'nav.about': 'About',
    'nav.dashboard': 'Dashboard',
    'hero.title': 'One person. Seven agents.',
    ...
    'features.steve': 'Product strategist and mentor. Asks the right questions.',
    'features.max': 'Infrastructure. Code, servers, deploy. Grey eminence.',
  ...
  es: {
    ...
    'nav.about': 'Sobre',
    'nav.dashboard': 'Dashboard',
    'hero.title': 'Una persona. Siete agentes.',
    ...
    'features.steve': 'Estratega de producto y mentor. Hace las preguntas correctas.',
    'features.max': 'Infraestructura. Código, servidores, despliegue.',
